...
class Providers_model extends Model
{
   ...
   protected $allowedFields = ['company', 'contact_name', 'contact_title', 'address', 'city', 'region', 'country', 'phone', 'email', 'website'];
   protected $searchFields = ['company', 'contact_name', 'contact_title', 'address', 'city'];
   ...
   public function filter($search = null, $limit = null, $start = null, $orderField = null, $orderDir = null)
   {
      ...
      $builder->select('id, company, contact_name, contact_title, address, city')
