...
class Machines_model extends Model
{
   ...
   protected $allowedFields = ['id_user', 'name_machine', 'cod', 'status'];
   protected $searchFields = ['id_user', 'name_machine', 'cod', 'status',];
   ...
   public function filter($search = null, $limit = null, $start = null, $orderField = null, $orderDir = null)
   {
      ...
      $builder->select('machines.id, machines.name_machine, machines.cod, machines.status, users.id AS Uid, users.first_name AS U_fn, users.last_name AS U_ln')
         ->join('users', 'users.id = machines.id_user')
   ...
   public function showMachines($id)
   {
      $builder = $this->db->table('machines')
         ->select('machines.id, machines.name_machine, machines.cod, machines.status, users.id AS Uid, users.first_name AS U_fn, users.last_name AS U_ln')
         ->join('users', 'users.id = machines.id_user')
