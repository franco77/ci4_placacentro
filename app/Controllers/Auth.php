...
class Auth extends BaseController
{
    ...
    public function index()
    {
        ...
        } else if ($this->ionAuth->inGroup('payments')) {
            $this->data['title'] = 'Pagos';
            return $this->renderPage('payments/dashboard/index', $this->data);
        }
    }
    ...
    public function login()
    {
        ...
        if ($this->request->getPost() && $this->validation->withRequest($this->request)->run()) {
            ...
            if ($this->ionAuth->login($this->request->getVar('identity'), $this->request->getVar('password'), $remember)) {
                ...
                // return redirect()->to('admin/dashboard/index')->withCookies();
                if ($this->ionAuth->isAdmin()) {
                    return redirect()->to('admin/dashboard');
                } else if ($this->ionAuth->inGroup('payments')) {
                    $this->session->markAsFlashdata('message', 'You must be a gangsta to view this page');
                    return redirect()->to('payments/dashboard/index');
                }
            } else {
    ...
    public function create_user()
    {
        ...
        // validate form input
        $this->validation->setRule('ic', 'Cedula', 'trim|required');
        ...
        $this->validation->setRule('birthdate', 'La fecha de nacimiento', 'trim|required');
        ...
        $this->validation->setRule('admission_date', 'Fecha de Ingreso ', 'trim|required');
        ...
        if ($this->request->getPost() && $this->validation->withRequest($this->request)->run() && $this->ionAuth->register($identity, $password, $email, $additionalData)) {
            ...
            $this->data['admission_date'] = [
                ...
                'id'    => 'datepicker',
                'class' => 'form-control',
                'value' => set_value('admission_date'),
            ];
            $this->data['password'] = [
                'name'  => 'password',
                'id'    => 'password',
    ...
    public function edit_user(int $id)
    {
        ...
        $this->data['company'] = [
            ...
            'selected' => set_value('company', empty($user->company) ? '' : $user->company),
        ];
        ...
        $this->data['admission_date'] = [
            ...
            'id'    => 'datepicker',
            'class' => 'form-control',
            'value' => set_value('admission_date', $user->admission_date ?: ''),
        ];
