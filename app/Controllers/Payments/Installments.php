...
class Installments extends BaseController
{
   ...
   function index()
   {
      $data = [
         ...
         'host' => site_url('payments/installments/')
      ];
      echo view('payments/installments/list', $data);
   }
   ...
   public function new()
   {
      ...
      echo view('payments/installments/form', $data);
   }
   ...
   function pdf($id = '')
   {
      ...
      $dompdf->loadHtml(view('payments/installments/pdf', $data));
