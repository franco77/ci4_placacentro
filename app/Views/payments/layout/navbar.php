        ...
        <ul class="navbar-nav ms-auto">
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <img src="<?= base_url('asset/img/user.jpg') ?>" alt="User Avatar"
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                    <img src="<?= base_url('asset/img/user.jpg') ?>" class="user-image img-circle shadow"
                        alt="User Image">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    ...
                    <li class="user-footer">
                        <a href="<?= base_url('user/index'); ?>" class="btn btn-default btn-flat">Perfil</a>
                        <a href="<?= base_url('auth/logout'); ?>" class="btn btn-default btn-flat float-end">Salir</a>
                    </li>
                </ul>
            </li>
