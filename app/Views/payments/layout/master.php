<!-- Haeder -->
<?= $this->include('payments/layout/header') ?>
<!--/Haeder -->
...
<body class="layout-fixed light-mode">
    ...
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <?= $this->include('payments/layout/navbar') ?>
        <!-- /.navbar -->

        <!-- Main Sidebar Container -->
        <?= $this->include('payments/layout/sidebar') ?>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php //echo esc($controller) 
                                                                                        ?>
                                </li>
                            </ol>
                        </div>
    ...
    <!-- Global Script -->
    <?= $this->include('payments/layout/globalscript') ?>
    <!--/Global Script -->
