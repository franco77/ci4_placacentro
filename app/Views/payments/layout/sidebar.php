          ...
          <div class="sidebar">
              <nav class="mt-2">
                  ...
                  <ul class="nav nav-pills nav-sidebar flex-column" data-lte-toggle="treeview" role="menu"
                      ...
                      <li class="nav-item">
                          <a href="<?= base_url('payments/dashboard/index') ?>" class="nav-link">
                      ...
                      <li class="nav-item">
                          <a href="<?= base_url('payments/customers/') ?>" class="nav-link">
                      ...
                      <li class="nav-item">
                          <a href="<?= base_url('payments/orders/') ?>" class="nav-link">
                      ...
                      <li class="nav-item">
                          <a href="<?= base_url('payments/installments/') ?>" class="nav-link">
                              <i class="nav-icon fa-solid fa-money-check"></i>
                              <p>Abonos</p>
                          </a>
                      </li>
